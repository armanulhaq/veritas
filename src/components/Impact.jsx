        ...
        <div className="mt-50 ">
            <div>
                <div className="flex flex-col items-center justify-center gap-3 mx-5 lg:mx-10 rounded-xl px-7 lg:px-15 py-5 ">
                    <div className="bg-[#faedcd] w-fit rounded-full p-5">
                        <img
                ...
                <div className=" grid grid-col-1 lg:grid-cols-2 m-5 lg:mx-10 gap-8 rounded-xl p-2 lg:p-10">
                    <div className="border bg-[#faedcd] border-[#e0c9a6] flex gap-4 px-10 py-15 rounded-xl ">
                        <div className="bg-[#faedcd] rounded-full w-fit h-fit p-5 lg-p-3">
                            <img
                                className="w-20 lg-w-10 bg-[#faedcd]"
                                src={users}
                                alt="users"
                            />
                        </div>
                        ...
                        <div className="flex flex-col gap-1 bg-[#faedcd]">
                            ...
                            <div className=" text-sm lg:text-lg bg-[#faedcd]">
                    ...
                    <div className="border border-[#e0c9a6] flex gap-4 px-10 py-15 rounded-xl bg-[#faedcd]">
                        <div className="bg-[#faedcd] h-fit rounded-full p-5 lg:p-2">
                            <img
                                className="w-20 lg-w-10 bg-[#faedcd]"
                                src={globe}
                                alt="users"
                    ...
                    <div className="border bg-[#faedcd] flex gap-4 px-10 py-15 rounded-xl">
                        <div className="bg-[#faedcd] h-fit rounded-full p-5 lg:p-2">
                            <img
                                className="w-20 lg-w-10 bg-[#faedcd]"
                                src={activity}
            ...
            <div className="flex items-center justify-center">
                <div className="w-[50%] border bg-[#f3dcaf] mx-5 lg:mx-60 rounded-xl px-7 lg:px-10 py-5 mb-7">
                    <div className="text-sm lg:text-lg bg-[#f3dcaf] font-serif">
                    ...
                    <div className="font-bold font-serif flex justify-end text-sm lg:text-md bg-[#f3dcaf]">
