...
const Analysis = () => {
    return (
        <div className="mx-5 lg:mx-10 rounded-xl flex flex-col gap-5 px-7 lg:px-15 w-[90vw] lg:w-[70vw]  shadow-2xl p-6">
            ...
            <div>
                ...
                <div className="text-xs text-gray-500 mt-1">
                    Enter the direct URL to a news article. The content will be
